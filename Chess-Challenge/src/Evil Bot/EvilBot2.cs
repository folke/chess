...
namespace ChessChallenge.Example
{
    ...
    public class EvilBot2 : IChessBot
    {
        ...
        public Move Think(Board board, Timer timer)
        {
            ...
            Console.WriteLine($"EvilBot: {current}");
            ...
            Console.WriteLine($"EvilBot: {bestMove} ({bestScore}) in {evals} evals");
        ...
        {
            int index = piece.IsWhite ? piece.Square.Index : piece.Square.Index ^ 56;
